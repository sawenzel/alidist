...
version: v0.1.5-coredigireco-snapshot-compatible-20221101
build_requires:
  - xjalienfs
...
alien.py cp /alice/cern.ch/user/a/aliperf/HEPscore/hepscore_checkpoint_20221101.tar.gz file:./hepscore_checkpoint.tar.gz
