...
setenv GEANT4VG_ROOT \$::env(BASEDIR)/$PKGNAME/\$version
setenv G4INSTALL \$::env(GEANT4VG_ROOT)
...
prepend-path PATH \$::env(GEANT4VG_ROOT)/bin
prepend-path ROOT_INCLUDE_PATH \$::env(GEANT4VG_ROOT)/include/Geant4
prepend-path ROOT_INCLUDE_PATH \$::env(GEANT4VG_ROOT)/include
prepend-path LD_LIBRARY_PATH \$::env(GEANT4VG_ROOT)/lib
$([[ ${ARCHITECTURE:0:3} == osx ]] && echo "prepend-path DYLD_LIBRARY_PATH \$::env(GEANT4VG_ROOT)/lib")
EoF
